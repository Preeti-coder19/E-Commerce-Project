...
<body>
	...
	<main id="main"> <!-- ======= Contact Section ======= --> <section
		...
		style="background-image: url(''); background-size: 1560px 700px;">
	...
	<div class="container">
		...
		<div class="row mt-5 justify-content-center">
			...
			%>
				<%
					try {
						...
						String sql = "select * from ratingtable";
						//out.print(sql);
			...
			<%
				...
				map.put("label", "Five Star");
				map.put("y", five);
				map.put("exploded", true);
				list.add(map);
				map = new HashMap<Object, Object>();
				map.put("label", "Four Star");
				map.put("y", four);
				list.add(map);
				map = new HashMap<Object, Object>();
				map.put("label", "Three Star");
				map.put("y", three);
				list.add(map);
				map = new HashMap<Object, Object>();
				map.put("label", "Two Star");
				map.put("y", two);
				list.add(map);
				map = new HashMap<Object, Object>();
				map.put("label", "One Star");
				map.put("y", one);
				list.add(map);
			...
			<script type="text/javascript">
				window.onload = function() {
					...
					var chart = new CanvasJS.Chart("chartContainer", {
						...
						exportFileName : "Customer Statisfaction Ratings",
						exportEnabled : true,
						title : {
							text : "Customer Statisfaction Ratings"
						},
						data : [ {
							type : "pie",
							showInLegend : true,
